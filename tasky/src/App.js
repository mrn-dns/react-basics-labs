...
function App() {
  ...
  const [ taskState, setTaskState ] = useState({
    tasks: [
      ...
      { id: 4, title: "Fold Clothes", description: "To be done after washing finished.",deadline: "Today" },
      { id: 5, title: "Clean kitchen", description: "Clean dishes and counter", deadline: "Today" }
    ]
  });
